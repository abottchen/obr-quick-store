export const STORE_STYLES = `
  ...
  .items-list-header .col-name { flex: 2; padding-left: 6px; }
  .items-list-header .col-type { flex: 1; }
  .items-list-header .col-price { width: 60px; text-align: right; flex-shrink: 0; }
  .item-row {
    display: flex;
    align-items: center;
    padding: 6px 10px;
